...
export const AccountLookupView = () => {
    ...
    const { cards, getCreditCards, getDebitCards } = useCardStore();
    ...
    const handleSearch = (e) => {
        ...
        const foundUser = users.find(user => {
            ...
            const fullName =
                `${user.UserName} ${user.UserSurname}`.toLowerCase();
                    ...
                    <main className="xl:col-span-3 space-y-8">
                        ...
                        <section>
                            ...
                            {result.cards.length === 0 ? (
                                <p className="text-gray-400">No posee tarjetas</p>
                            ) : (
